...
/***/ (function(module, exports) {
    ...
    function _assertThisInitialized(self) {
      ...
      ***************************************************************************** */
        ...
        _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(ResponsiveControl, [{
          ...
          value: function render() {
            ...
            return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("div", {
              className: 'kadence-responsive-control-bar'
              ...
              className: "kadence-responsive-controls-content"
            }, this.props.children));
          }
        }, {
          key: "changeViewType",
          ...
          */
          var initHeaderBuilderPanel = function initHeaderBuilderPanel(panel) {
            var section = wp.customize.section('section-header-builder'),
                $section = section.contentContainer; // section_layout =  wp.customize.section( 'kadence_customizer_header_layout' );
            ...
            $section.on('click', '.kadence-builder-tab-toggle', function (e) {
              e.preventDefault();
              $section.toggleClass('kadence-builder-hide'); // resizePreviewer();
            });
          };
      ...
      /* harmony import */ var _layout_builder_control_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./layout-builder/control.js */ "./src/layout-builder/control.js");
      /* global wp */
      
      
      
      wp.customize.controlConstructor.astra_builder_control = _layout_builder_control_js__WEBPACK_IMPORTED_MODULE_2__["BuilderControl"];
      ...
      var AddComponent = /*#__PURE__*/function (_Component) {
        ...
        _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(AddComponent, [{
          ...
          value: function render() {
            ...
            var classForAdd = 'kadence-builder-add-item';
            ...
            return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("div", {
              ...
              position: "top",
              className: "kadence-popover-add-builder",
              onClose: toggleClose
            }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("div", {
              className: "kadence-popover-builder-list"
            }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(ButtonGroup, {
              className: "kadence-radio-container-control"
      ...
      /* harmony import */ var _row_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./row-component */ "./src/layout-builder/row-component.js");
      ...
      var BuilderComponent = /*#__PURE__*/function (_Component) {
        ...
        function BuilderComponent() {
          ...
          _this.choices = astraCustomizerControlsData && astraCustomizerControlsData.choices && astraCustomizerControlsData.choices[_this.controlParams.group] ? astraCustomizerControlsData.choices[_this.controlParams.group] : [];
          _this.state = {
            value: value
          };
          return _this;
        ...
        _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(BuilderComponent, [{
          ...
          value: function removeItem(item, row, zone) {
            ...
            var event = new CustomEvent('kadenceRemovedBuilderItem', {
          ...
          value: function render() {
            ...
            return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("div", {
              className: "kadence-control-field kadence-builder-items"
              ...
              className: "kadence-builder-row-items"
      ...
      var BuilderControl = wp.customize.astraControl.extend({
      ...
      /* harmony import */ var _common_icons_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../common/icons.js */ "./src/common/icons.js");
      /* harmony import */ var _item_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./item-component */ "./src/layout-builder/item-component.js");
      /* harmony import */ var _add_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./add-component */ "./src/layout-builder/add-component.js");
        ...
        _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(DropComponent, [{
          ...
          value: function render() {
            ...
            return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("div", {
              ...
              className: "kadence-builder-drop kadence-builder-sortable-panel kadence-builder-drop-".concat(location, "_center"),
              list: theCenterItems,
              ...
              group: this.props.controlParams.group,
              className: "kadence-builder-drop kadence-builder-sortable-panel kadence-builder-drop-".concat(location),
              list: theItems,
              setList: function setList(newState) {
      ...
      var ItemComponent = /*#__PURE__*/function (_Component) {
        ...
        function ItemComponent() {
          ...
          _this = _super.apply(this, arguments);
          _this.choices = astraCustomizerControlsData && astraCustomizerControlsData.choices && astraCustomizerControlsData.choices[_this.props.controlParams.group] ? astraCustomizerControlsData.choices[_this.props.controlParams.group] : [];
          return _this;
        }
        ...
        _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(ItemComponent, [{
          ...
          value: function render() {
            ...
            return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("div", {
              className: "kadence-builder-item",
      ...
      /* harmony import */ var _common_responsive_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../common/responsive.js */ "./src/common/responsive.js");
      /* harmony import */ var _common_icons_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../common/icons.js */ "./src/common/icons.js");
      /* harmony import */ var _drop_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./drop-component */ "./src/layout-builder/drop-component.js");
      ...
      var RowComponent = /*#__PURE__*/function (_Component) {
        ...
        _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(RowComponent, [{
          ...
          value: function render() {
            ...
            var besideItems = [];
            return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("div", {
              className: "kadence-builder-areas ".concat(centerClass)
            }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(Button, {
              className: "kadence-row-actions",
              onClick: function onClick() {
                return _this.props.focusPanel(mode + '_' + _this.props.row);
              }
            }, this.props.row === 'popup' ? __('Off Canvas', 'kadence') : this.props.row + ' ' + __('Row', 'kadence'), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(Dashicon, {
              icon: "admin-generic"
            })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("div", {
              className: "kadence-builder-group kadence-builder-group-horizontal",
