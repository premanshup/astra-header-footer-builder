...
class BuilderComponent extends Component {
	constructor() {
		...
		this.choices = ( astraCustomizerControlsData && astraCustomizerControlsData.choices && astraCustomizerControlsData.choices[ this.controlParams.group ] ? astraCustomizerControlsData.choices[ this.controlParams.group ] : [] );
		this.state = {
			value: value,
		};
	}
	...
	render() {
		return (
			<div className="kadence-control-field kadence-builder-items">
