...
class ItemComponent extends Component {
	constructor() {
		super( ...arguments );
		this.choices = ( astraCustomizerControlsData && astraCustomizerControlsData.choices && astraCustomizerControlsData.choices[ this.props.controlParams.group ] ? astraCustomizerControlsData.choices[ this.props.controlParams.group ] : [] );
	}
	render() {
		return (
